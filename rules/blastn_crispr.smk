rule blast_chunks_spacers:
    input:
        donefile = "makeblastdb_spacers.done",
        chunk = "{phage_db_id}/chunks/part_{chunk}.fasta",
    output:
        temp("{phage_db_id}/results/spacers/{chunk}.blast")
    resources:
        cpus_per_task = 24,
        runtime = 7200,
        mem = "100GB"
